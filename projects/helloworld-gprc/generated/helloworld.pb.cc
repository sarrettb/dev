...
const char descriptor_table_protodef_helloworld_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
    ...
    "ld.HelloResponse\"\000b\006proto3"
};
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "helloworld.HelloRequest.message"));
        } else {
          goto handle_unusual;
        }
        continue;
...
::uint8_t* HelloRequest::_InternalSerialize(
  ...
  if (!this->_internal_message().empty()) {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE, "helloworld.HelloRequest.message");
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 10)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "helloworld.HelloResponse.message"));
        } else {
          goto handle_unusual;
        }
        continue;
...
::uint8_t* HelloResponse::_InternalSerialize(
  ...
  if (!this->_internal_message().empty()) {
    const std::string& _s = this->_internal_message();
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE, "helloworld.HelloResponse.message");
    target = stream->WriteStringMaybeAliased(1, _s, target);
  }
...
template<> PROTOBUF_NOINLINE ::helloworld::HelloResponse*
Arena::CreateMaybeMessage< ::helloworld::HelloResponse >(Arena* arena) {
